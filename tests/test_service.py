...
from hazardous_ledger_core.errors import ConflictError, PermissionDenied
...
class ServiceTest(unittest.TestCase):
    def setUp(self):
        ...
        self.service.register_organization(request_id="org", actor_id="bootstrap", organization_id="o1", name="企业一")
    ...
    def test_same_request_replays_original_receipt(self):
        first = self.service.record_domain_data(request_id="data", actor_id="op1", site_id="s1",
                                                category="waste_category", external_key="k1", data={"value": 1})
    ...
    def test_request_id_rejects_changed_payload(self):
        ...
        with self.assertRaises(ConflictError):
            self.service.record_domain_data(request_id="data", actor_id="op1", site_id="s1",
                                            category="waste_category", external_key="k1", data={"value": 2})
